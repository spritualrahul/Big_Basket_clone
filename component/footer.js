function footer() {
    ...
    <div class="move">
        ...
        <a class="facebookBtn smGlobalBtn" href="https://www.facebook.com/pages/Bigbasketcom/139311472851666" target="_blank"></a>
    </div>
</header>
<hr>
...
<div class="main">
    ...
    <div class="moveside">
        <span class="groupgreen"> POPULAR CATEGORIES:</span>
        <span class="side10">
    ...
    <div class="moveside">
        ...
        <span class=" side20">
            Amul, Nescafe , MTR, RED BULL , elite cake, Pediasure, Yummiez, Yera, Yakult, Britannia, Wow Momo,
    ...
    <br>
    <div class="moveside">
        <span class="groupgreen"> CITIES WE SERVE:</span>
        <span class="moveinside">
            ...
            Rural, Mysore Rural, Nagpur Rural, Patna Rural, Pune Rural, Surat Rural, Vadodara Rural, Jaipur Rural,
            Ranchi, Nashik, Agra,</span>
    </div>
    <br>


    <div class="moveside">
        <span class="groupgreen">PAYMENT OPTIONS:</span>
